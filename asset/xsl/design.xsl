        ...
        <html lang="en" xml:lang="en">
            <head>
                <title>
                    ...
                    on your browsers tab--> A.B Wiskadals Fabrik Catalog: Design
                    At A Glance </title>
            ...
            <body>
                ...
                <main>
                    ...
                    <div class="container">
                        ...
                        <!-- each div that has the type page is selected along with the image that is associated with that page through the @facs-->
                                    ...
                                    <article>
                                        ...
                                        <img class="img_medium">
                                            ...
                                            <xsl:attribute name="src">
                                                <xsl:value-of
                                                  select="//tei:surface[@xml:id = substring-after($facs, '#')]/tei:figure/tei:graphic/@url"
                                                />
                                            </xsl:attribute>
                        ...
                        <div class="col-sm copyright">
                            <div>
                                <a href="https://creativecommons.org/licenses/by/4.0/legalcode">
                                    <img src="assets/img/cc.svg" class="copyright_logo"
                                        alt="Creative Commons License"/>
                                    <img src="assets/img/by.svg" class="copyright_logo"
